...
export const AddressInput = ({
  ...
  return (
    <fieldset>
      {showLegend && (
        <legend className="block body-sm font-medium text-gray-700 mb-1">
          {legend}
        </legend>
      )}
      <div className="bg-white rounded-md shadow-sm -space-y-2px">
        <div>
          ...
          <input
            ...
            onChange={(e) =>
              onChange({ ...selectedValue, address2: e.target.value })
            }
          />
        </div>
        <div className="-mt-1">
          ...
          <input
            ...
            value={
              ...
              selectedValue?.address1 || selectedValue?.address1 === ''
        ...
        <div className="flex -space-x-px">
          <div className="w-1/3 flex-1 min-w-0">
            ...
            <input
              ...
              value={
                // eslint-disable-next-line no-nested-ternary
                selectedValue?.city || selectedValue?.city === ''
                  ? selectedValue?.city
                  : defaultAddress?.city
                  ? defaultAddress?.city
                  : ''
          ...
          <div className="flex-1 min-w-0">
            ...
            <input
              value={
                // eslint-disable-next-line no-nested-ternary
                selectedValue?.pincode || selectedValue?.pincode === ''
