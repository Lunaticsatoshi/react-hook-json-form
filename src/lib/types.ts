...
export type Widget = React.FC<IBaseWidgetProps>;
...
export interface IBaseFieldProps<T = any>
  extends Pick<
    React.HTMLAttributes<HTMLElement>,
    Exclude<keyof React.HTMLAttributes<HTMLElement>, 'onBlur' | 'onFocus'>
  > {
...
export type Field = React.FC<IBaseFieldProps>;
...
export type StackFieldTemplateProps<T = any> = {
  DescriptionField?: React.FunctionComponent<{
    id: string;
    description: string | React.ReactElement;
  }>;
...
export type ArrayFieldTemplatePropsNew<T = any> = {
  DescriptionField?: React.FunctionComponent<{
    id: string;
    description: string | React.ReactElement;
  }>;
